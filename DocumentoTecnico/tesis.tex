...
\include{DocumentoTecnico/Latex/Macros/MacroFile1}           % Archivo con funciones útiles
...
\degreedate{26 de enero de 2023}            % Año de la fecha de la presentación
...
\input{DocumentoTecnico/Capitulo1/descripcion_documento}
\include{DocumentoTecnico/Capitulo1/introduccion}
\include{DocumentoTecnico/Capitulo2/marco_teorico}
\include{DocumentoTecnico/Capitulo3/analisis_sistema}
\include{DocumentoTecnico/Capitulo4/diseno_sistema}
\include{DocumentoTecnico/Capitulo5/desarrollo}
\include{DocumentoTecnico/Capitulo6/pruebas}
\include{DocumentoTecnico/Capitulo7/conclusiones}
\include{DocumentoTecnico/Extras/trabajo_futuro}
\include{DocumentoTecnico/Extras/glosario}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\appendix
\include{DocumentoTecnico/Apendice1/Apendice1}               % Colocar los circuitos, manuales, código fuente, pruebas de teoremas, etc.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%                   REFERENCIAS                     %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\bibliography{DocumentoTecnico/Bibliografia/referencias}             % Archivo .bib
